...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('/author', 'AppController@getAuthorPage');
    // [
    ...
    Route::get('/author/generate-article', 'AppController@getGenerateArticle');
    // [
    ...
    Route::get('/admin', 'AppController@getAdminPage');
